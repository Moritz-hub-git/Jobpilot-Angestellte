# Master-CV (englisch, editierbare Fassung)

> Quelle der Formulierungen: `career/dossier.md` + Alt-CV-Wortwahl. Jede Zeile Fakten-Gate-geprüft; Abweichungen vom Alt-CV dokumentiert in `notizen.md`. Pro Bewerbung wird dieser Master kopiert und zugespitzt (Summary + Bullet-Auswahl), nie verlängert. Gerenderte Fassung: `cv-master.html` → `cv-master.pdf` (1 Seite A4).

---

**MORITZ SCHUMACHER**
me@moritz-schumacher.com | linkedin.com/in/moritz-schumacher | Dortmund, Germany — open to relocate

Digital strategist with a dual-track background: deep industrial DNA (thyssenkrupp nucera) combined with digital venture experience (Hubert Burda Media) — and the rare habit of building what he proposes. Ships production AI end-to-end: from use-case discovery and board approval to tools that teams actually use.

## PROFESSIONAL EXPERIENCE

**thyssenkrupp nucera** (SDAX-listed hydrogen electrolyzer manufacturer) | Dortmund
...
## AI PRODUCT PORTFOLIO (personal)

- Shipped 3 native iOS apps end-to-end (Swift, AI-assisted with Claude Code): backends, databases, web versions, AI-API integrations (Gemini/Google Cloud), App Store review and releases — incl. cost-optimized image reuse via similarity caching.

## LEADERSHIP (volunteer)

- Chairman, fencing division at the State Training Center Hagen: led 4 coaches and 4 board members, restructured tournaments to a clearly positive result — 10/2017 – 03/2021. Certified coach; former state champion (Westphalia).

## EDUCATION

- **Zeppelin University**, Friedrichshafen — M.Sc. Corporate Management & Economics; Minor: M.A. Public Management & Digitalization — 09/2020 – 06/2022
- **BiTS Iserlohn** — B.Sc. Business and Management Studies — 09/2017 – 07/2020 · Exchange: **Monash University Malaysia** (2019)

## SKILLS

- **Tech:** AI-assisted development (Claude Code) · Swift/iOS · backends, databases & web · AI-API integration (OpenAI, Gemini/Google Cloud) · MS Power Platform (Apps, Automate, BI, Dataverse, Copilot) · Figma
- **Methods:** AI use-case discovery & business cases · program/PMO leadership · executive communication · financial modeling · prototyping & product validation
- **Languages:** German (native) · English (fluent — current working language)
